...
public class Lec36BestTimeToBuyAndSellStock2 {
...
//        return (int) solveRecursive(prices, 0, 1);
    ...
    static long solveRecursive(int[] prices, int ind, int buy){
        ...
        if (buy == 1){
            ...
            profit = Math.max(prices[ind]+solveRecursive(prices, ind+1,1),
    ...
    static long solveMemoized(int[] prices, int ind, int buy, long[][] memArray){
        ...
        if (buy == 1){
            ...
            profit = Math.max(prices[ind]+solveMemoized(prices, ind+1,1, memArray),
